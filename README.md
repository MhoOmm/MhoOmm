...
<details>
  <summary>🕹️ Secret Console — Open?</summary>

  <pre>
init gamer_mode --theme "dark-purple" --fps "uncapped"

alias deploy="git push origin main && echo 'gg wp'"

echo "hydrate + chill + commit"
  </pre>
</details>
