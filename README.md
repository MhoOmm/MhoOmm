...
<p align="center">
  <img
    src="https://readme-typing-svg.demolab.com?font=JetBrains+Mono&weight=900&size=22&pause=1200&color=9B5CFF&center=true&vCenter=true&width=780&lines=Full-Stack+Developer;Web+Dev+%7C+APIs+%7C+Cloud;Coding+to+EDM+drops+%26+808s;Energy+mode%3A+ON;Building+clean+%26+scalable+systems"
  />
</p>

<p align="center">
  <a href="https://www.linkedin.com/in/omm-tripathi-090762365/">LinkedIn</a> •
  <a href="https://github.com/MhoOmm">GitHub</a> •
...
const Omm = {
  ...
  architecture: ["microservices", "event-driven", "modular systems"],
  interests: {
    gaming: ["FPS", "open-world", "souls-like"],
    music: ["hip-hop", "edm", "retro-rock"],
    reading: ["system design", "dev culture"]
  },
  challenge:
...
<details> <summary>🕹️ Secret Console — Open?</summary> <pre> init gamer_mode --theme "dark-purple" --fps "uncapped" alias deploy="git push origin main && echo 'gg wp'" echo "hydrate + chill + commit" </pre> </details> ```
